...
Так же для конвертации из .xlsx в .png нам нужно установить libreoffice:

`apt update`

`apt install libreoffice`

>Иногда бот может потребоваться изменить soffice_path, но чаще всего работает всё из под коробки!
