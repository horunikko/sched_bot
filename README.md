...
Для начала необходимо установить poppler-utils для конвертации в .png из .pdf
Команда: `sudo apt update 
sudo apt install poppler-utils`

Установка библиотек:
`pip install aiogram, openpyxl, pdf2image, aiohttp`

## Настройка файла settings.py

- Первым делом вам нужно установить libreoffice. Он необходим для преобразования из формата .xlsx в .pdf. Установка командой на линуксе: apt install libreoffice. Может потребоваться изменить soffice_path, но чаще всего можете его не изменять.
